...
urlpatterns = [
    ...
    path('add-to-favorites/', views.add_to_favorite, name="add-to-favorite"),
    ...
    path('remove-favorites/<int:favorites_id>/', views.remove_favorites, name="remove-favorites"),
    ...
    path('accounts/add-address/', views.DeliveryView.as_view(), name="add-address"),
    path('accounts/remove-address/<int:id>/', views.remove_address, name="remove-address"),
    path('accounts/add-reservation/', views.ReservationView.as_view(), name="reservation"),
    path('accounts/order-verification/', views.upload_file, name="order-slip"),
    path('accounts/remove-reservation/<int:id>/', views.remove_reservation, name="remove-reservation"),
